...
| ---------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Everying is in kernel, a mistake is <br>fatal, <br>because an error in the supervisor mode <br>will often cause the kernel to fail | ==OS services running as process called servers.==<br><br>Kernel provides an inter-process communication <br>mechanism to send msg from one user-mode to another.<br><br>For instance, file system runs as a user-level process<br>![[MIT OS Engineering-20240528135244522.webp]] |
|                                                                                                                                    | The kernel is simple for consisting of a few low-level <br>functions for starting apps, sending msgs, accessing hardware resources.<br>Most of OS resides in user-level servers                                                                                                   |
